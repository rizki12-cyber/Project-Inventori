...
<div class="container py-5 form-container">
    <div class="d-flex align-items-center mb-4">
        <h2 class="page-title">
            <i class="bi bi-plus-circle-dotted me-2"></i>Tambah Barang Kabeng
        </h2>
    </div>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="kode_barang" class="form-control"
                        placeholder="Contoh : K002" value="{{ old('kode_barang') }}" required>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="kategori" class="form-control"
                        placeholder="Contoh: Komputer, Meja, Kursi" value="{{ old('kategori') }}" required>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="date" name="tanggal_penghapusan" class="form-control"
                        value="{{ old('tanggal_penghapusan') }}">
                </div>

                <div class="col-md-6">
                    <label class="form-label">Sumber Anggaran</label>
                    <input type="text" name="sumber_dana" class="form-control"
                        placeholder="Contoh: BOS, Komite, Hibah"
                ...
                <div class="col-12">
                    ...
                    <textarea name="spesifikasi" rows="3" class="form-control"
