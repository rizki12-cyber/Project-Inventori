...
<div class="container py-5 data-container">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-3">
        ...
        <a href="{{ route('admin.konsentrasi.create') }}" class="btn btn-add">
            <i class="fas fa-plus-circle"></i> +Tambah Konsentrasi
        </a>
    </div>
    ...
    <div class="card p-4">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex justify-content-center gap-2">
                                ...
                                <!-- Edit -->
                                <a href="{{ route('admin.konsentrasi.edit', $item->id) }}" class="btn btn-sm btn-warning">
                                    <i class="bi bi-pencil-square"></i>
                                </a>

                                <!-- Delete -->
                                <form action="{{ route('admin.konsentrasi.destroy', $item->id) }}"
                                      method="POST"
        ...
        <div class="empty-state">
            ...
            <div>Belum ada data konsentrasi</div>
            <a href="{{ route('admin.konsentrasi.create') }}" class="btn btn-add mt-3">
                <i class="fas fa-plus-circle"></i> Tambah Konsentrasi Pertama
            </a>
        </div>
        @endif
    </div>
